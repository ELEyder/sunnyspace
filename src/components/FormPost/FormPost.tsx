    ...
    return (
        <>
            <form className={styles.postear} encType="multipart/form-data">
                <input className={styles.content} type="text" name="content" placeholder="¿En que piensas?" maxLength={1000} />
                <div className={styles.postearOption}>
                    ...
                    <Button type='button' onClick={() => setPrivacity(privacity === 'public' ? 'private' : 'public')}>
                        {privacity === 'public' ? svgPublic : svgPrivate}
                    </Button>
                    <Button type="submit">
                        Postear
                    </Button>
